...
const Crypto = () => {
  return (
    <section className="crypto_section relative w-full overflow-hidden py-20 lg:py-32 bg-gray-900 text-white">
      {/* Background Elements */}
      <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-purple-500/30 rounded-full filter blur-3xl"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-25 items-center">
          ...
          <div className="content_container space-y-8 order-1 lg:order-2">
            ...
            <div className="flex flex-col lg:flex-row gap-5">
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 hover:shadow-lg transition-all duration-300">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              ...
              <button className="inline-flex items-center justify-center px-6 py-3 border-2 border-gray-600 text-gray-300 font-semibold rounded-2xl hover:bg-gray-800 hover:border-gray-400 transition-all duration-200">
                View Demo
