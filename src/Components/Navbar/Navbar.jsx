  ...
  return (
    <div className="bg-gradient-to-r from-[#151C2B] via-[#2C3548] to-gray-800 shadow-2xl sticky top-0 z-50 py-2">
      <div className="navbar max-w-7xl mx-auto px-4 sm:px-6 md:px-16 2xl:px-22 py-3 relative">
        ...
        <div
          tabIndex={0}
          className={`h-[100vh] bg-black/30 absolute left-0 top-0 transition-all duration-300 ease-in-out ${isActive ? "w-full" : "w-0 overflow-hidden"
            }`}
          onClick={() => setIsActive(false)}
        >
          <div
            className={`h-full bg-gradient-to-b from-[#151C2B] via-[#2C3548] to-gray-800 px-5 transition-all duration-500 ease-in-out ${isActive ? "w-[80%]" : "w-0 overflow-hidden"
              }`}
          >
